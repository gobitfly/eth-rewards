...
func ProcessProposerSlashings(
	...
	for _, slashing := range slashings {
		beaconState, err = ProcessProposerSlashing(ctx, beaconState, slashing, slashFunc, income)
		if err != nil {
			return nil, err
		}
	}
...
func ProcessProposerSlashing(
	...
	beaconState, err = slashFunc(ctx, beaconState, slashing.Header_1.Header.ProposerIndex, slashingQuotient, cfg.ProposerRewardQuotient, income)
	if err != nil {
