...
func ProcessAttestationsNoVerifySignature(
	...
	for idx, att := range body.Attestations() {
		beaconState, err = ProcessAttestationNoVerifySignature(ctx, beaconState, att, totalBalance, income)
		if err != nil {
...
func ProcessAttestationNoVerifySignature(
	...
	return SetParticipationAndRewardProposer(ctx, beaconState, att.Data.Target.Epoch, indices, participatedFlags, totalBalance, income)
}
...
func SetParticipationAndRewardProposer(
	...
	if err := RewardProposer(ctx, beaconState, proposerRewardNumerator, income); err != nil {
		return nil, err
	}
