...
func ProcessRewardsAndPenaltiesPrecompute(
	...
	attsRewards, attsPenalties, err := AttestationsDelta(beaconState, bal, vals, income)
	if err != nil {
...
func AttestationsDelta(beaconState state.BeaconState,
	...
	for i, v := range vals {
		rewards[i], penalties[i], err = attestationDelta(i, bal, v, baseRewardMultiplier, inactivityDenominator, leak, income)
		if err != nil {
			return nil, nil, err
		}
	}
...
func attestationDelta(index int,
	bal *precompute.Balance,
